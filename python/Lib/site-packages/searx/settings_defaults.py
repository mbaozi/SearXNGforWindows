...
SCHEMA = {
    ...
    'ui': {
        'static_path': SettingsDirectoryValue(str, os.path.join(searx_dir, 'static').replace("\\", "/")),
        'static_use_hash': SettingsValue(bool, False, 'SEARXNG_STATIC_USE_HASH'),
        'templates_path': SettingsDirectoryValue(str, os.path.join(searx_dir, 'templates').replace("\\", "/")),
